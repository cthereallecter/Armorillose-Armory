...
namespace Armorillose.Content.Items.Weapons.Magic
{
    public class EyeBeamStaff : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            Item.staff[Item.type] = true; // Makes the item rotate correctly when used
        }
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<EyeBeamProjectile>();
            Item.shootSpeed = 20f;
        ...
        {
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<Materials.DemonEyeLens>(), 12)
